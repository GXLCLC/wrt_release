...
update_feeds() {
    ...
    #不要了过时原仓库迁移append_feed_if_missing "$FEEDS_PATH" "ddnsto" "src-git ddnsto https://github.com/linkease/ddnsto-openwrt.git;main"
    #添加新的DDNSTO源
    ...
    #添加turboacc源
    append_feed_if_missing "$FEEDS_PATH" "luci-app-turboacc" "src-git luci-app-turboacc https://github.com/chenmozhijin/turboacc.git;luci"
